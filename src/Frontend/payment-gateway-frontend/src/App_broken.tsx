...
function App() {
  ...
  const [currentView, setCurrentView] = useState<'dashboard' | 'payments' | 'settings' | 'register'>('dashboard');
  ...
  const handlePayment = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(`Pagamento processado com sucesso! ID: ${response.data.id}`);
              ...
              <div className="settings-section">
                ...
                <div className="settings-grid">
                  <div className="setting-card">
                    ...
                    <p>Gerenciar perfil e preferências</p>
                    <button className="btn-setting" disabled>
                      Em desenvolvimento
                    </button>
                  </div>
